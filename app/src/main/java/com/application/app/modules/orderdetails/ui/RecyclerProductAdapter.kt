...
import com.application.app.databinding.RowOrderDetails1Binding
import com.application.app.modules.orderdetails.`data`.model.OrderDetails1RowModel
import kotlin.Int
import kotlin.Unit
import kotlin.collections.List

public class RecyclerProductAdapter(
  public var list: List<OrderDetails1RowModel>
) : RecyclerView.Adapter<RecyclerProductAdapter.RowOrderDetails1VH>() {
